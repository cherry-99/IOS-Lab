...
main(int argc, char *argv[])
{
 ...
 101:	83 c4 10             	add    $0x10,%esp
				for(x=0; x<40000.0; x+=0.1){
 104:	dd 05 80 08 00 00    	fldl   0x880
 ...
 12a:	52                   	push   %edx
 12b:	50                   	push   %eax
 12c:	68 40 08 00 00       	push   $0x840
 131:	6a 01                	push   $0x1
 133:	e8 c8 03 00 00       	call   500 <printf>
			exit();
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 8c 08 00 00       	mov    $0x88c,%eax
